...
#define CONTROLS_GROUP_START 53
    ...
    { WWT_CHECKBOX,         2,  10,     299,    CONTROLS_GROUP_START + 75,   CONTROLS_GROUP_START + 86,   STR_TOGGLE_WINDOW,                      STR_TOGGLE_WINDOW_TIP },                   // Zoom to cursor
...
*/
    { WWT_LABEL,            1,  23,     298,    145,    159,    STR_OPTIONS_AUTOSAVE_FREQUENCY_LABEL,       STR_NONE },
    SPINNER_WIDGETS       ( 1,  165,    289,    145,    156,    STR_NONE,                                   STR_AUTOSAVE_FREQUENCY_TIP ),                       // NB: 3 widgets
        ...
        case WINDOW_OPTIONS_PAGE_CONTROLS_AND_INTERFACE:
            switch (widgetIndex)
            {
                ...
                case WIDX_ZOOM_TO_CURSOR:
                    ...
                    window_invalidate(w);
                    break;
                case WIDX_TOGGLE_WINDOW:
                    gConfigGeneral.toggle_window ^= 1;
                    config_save_default();
                    window_invalidate(w);
                    break;
...
static void window_options_invalidate(rct_window* w)
{
    ...
    switch (w->page)
    {
        ...
        case WINDOW_OPTIONS_PAGE_CONTROLS_AND_INTERFACE:
        {
            ...
            widget_set_checkbox_value(w, WIDX_TOGGLE_WINDOW, gConfigGeneral.toggle_window);
    ...
    switch (w->page)
    {
        ...
        case WINDOW_OPTIONS_PAGE_CONTROLS_AND_INTERFACE:
        {
            gfx_draw_string_left(
                ...
                w->y + window_options_controls_and_interface_widgets[WIDX_THEMES_DROPDOWN].top + 1);
            gfx_draw_string_left(
