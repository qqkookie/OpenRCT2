...
// STR_2746    :]
    ...
    STR_ELAPSED_DAYS = 6303,
    STR_COMPLETED_BY_WITH_COMPANY_VALUE_ALT = 6304,
    STR_COMPLETED_DAYS = 6305,

    STR_ROTATE_CCW_TIP = 6306,
    STR_TOGGLE_WINDOW = 6307,
    STR_TOGGLE_WINDOW_TIP = 6308,
