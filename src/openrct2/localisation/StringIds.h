...
enum
{
    ...
    STR_SPEED_SLOW = 6301,
    STR_SPEED_SLOWER = 6302,

    STR_COMPLETED_BY_WITH_COMPANY_VALUE_ALT = 6303,
    STR_COMPLETED_DAYS = 6304,
    STR_ELAPSED_DAYS = 6305,

    STR_TOGGLE_WINDOW = 6306,
    STR_TOGGLE_WINDOW_TIP = 6307,
    STR_SAVE_EVERY_N_MINUTES = 6308,
